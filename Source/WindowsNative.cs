...
namespace SharpSlugsEngine
{
    ...
    /// </summary>
    [SuppressMessage("Microsoft.StyleCop.CSharp.NamingRules", "*", Justification = "These are the correct names according to Windows documentation.")]
    [SuppressMessage("Microsoft.StyleCop.CSharp.DocumentationRules", "*", Justification = "Everything here is documented in the commented links.")]
    internal static class WindowsNative
    {
        ...
        private static Guid hidGuidInternal = Guid.Empty;

        /// <summary>
        /// Gets the GUID for HIDClass devices
        /// </summary>
        internal static Guid HidGuid
        {
            get
            {
                if (hidGuidInternal == Guid.Empty)
                {
                    HidD_GetHidGuid(ref hidGuidInternal);
                }

                return hidGuidInternal;
            }
        }
        ...
        internal struct SP_DEVINFO_DATA
        {
            ...
            /// <summary>
            /// Fills this <see cref="SP_DEVINFO_DATA"/> struct with correct default values
            /// </summary>
        ...
        internal struct SECURITY_ATTRIBUTES
        {
            ...
            /// <summary>
            /// Fills this <see cref="SECURITY_ATTRIBUTES"/> struct with correct default values
            /// </summary>
            public void SetupDefaults()
            {
